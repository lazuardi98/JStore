...
public class JStore
{
    ...
    public static void main(String[] args)
    {
        ...
        Supplier supplier1 = new Supplier("Toko", "toko@toko.com", "1-888-678-3688", location1);
        ...
        Item item2 = new Item("Apple Mac", ItemStatus.Second, 15000000, supplier1, ItemCategory.Electronics);
        DatabaseItem.addItem(item2);
        Item item3 = new Item("Sony Xperia", ItemStatus.Refurbished, 5000000, supplier1, ItemCategory.Electronics);
        ...
        System.out.println(DatabaseInvoice.getInvoice(3)); */
